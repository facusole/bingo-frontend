...
description: Different data fetching patterns for different use cases.
---

# Data Patterns

Choose the right data fetching pattern for each use case. Ask the user for more information if in doubt of the real need of the app.
